...
const locationList = [
  ...new Set(Data.map((element) => element.location))
];
        ...
        <div className={`drawer`} ref={dropdownRef}>
          <div className={`drawer-contents`}>
              ...
              <button className="select-button set-values">
                <button class="search-button" onClick={() => onSubmit()}>
                  <div className="flex-container">
                    <span className="material-icons"><Search fontSize="small" /></span>
            ...
            <div className="search-container">
                ...
                {showLocationOptions ? (
                  <div>
                    {locationList.map((location_name) => (
                      ...
                      >
                        <span className="material-icons"><LocationOnOutlined fontSize="small"/></span>
              ...
              {/* For Guests *---Not supplying neccessary data/}
